<!-- component -->
<footer class="w-auto p-4 bottom-0 h-auto relative bg-gray-200 mt-28 ">
        <div class="container lg:flex  lg:mt-3 md:mx-12 lg:mx-28 lg:justify-between">
            <div class="mb-4 lg:columns-1 w-96">
                <p class="text-white font-bold mb-1 mt-3">About Us</p>
                <p class="text-gray-400 text-sm">Lorem Ipsum is simply dummy text of the printing.. 
                </p>
            </div>
            ...
            <div class="lg:mt-3 mb-4">
                ...
                <div class="columns-2 md:columns-3 lg:columns-2">
                    <a class="text-gray-400 hover:text-cyan-700" href="">Navigate 0</a><br>
                    <a href="" class="text-gray-400  hover:text-cyan-700">Navigate 1</a><br>
                    <a class="text-gray-400  hover:text-cyan-700" href="">Navigate 2</a><br>
                    <a class="text-gray-400  hover:text-cyan-700" href="">Navigate 3</a><br>
                    <a href="" class="text-gray-400  hover:text-cyan-700">Navigate 4</a><br>
                    <a href="" class="text-gray-400  hover:text-cyan-700">Navigate 5</a><br>
                </div>
            </div>
        </div>
        <div>
